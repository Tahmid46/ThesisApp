...
public class ReminderActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private Button dateView,timeView1,timeView2,timeView3;
    ...
    private boolean validmedname(){
        ...
        else if(mednameintput.length()>15){
            med_name.setError("Medicine Name too long");
            return false;
        }
        else{
    ...
    private boolean validdocname(){
        ...
        else if(docnameintput.length()>15){
            doc_name.setError("Doctor's name is too long");
            return false;
        }
        else{
    ...
    private boolean validduration(){
        ...
        else if(durationintput.length() > 15){
            duration.setError("Number of days should be within 3 digits");
            return false;
        }
        else{
