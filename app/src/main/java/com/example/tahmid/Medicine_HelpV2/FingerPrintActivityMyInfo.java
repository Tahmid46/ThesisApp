...
public class FingerPrintActivityMyInfo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_finger_print_my_info);
        ...
        if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            if(!fingerprintManager.isHardwareDetected()){
                ...
                if (cipherInit()){
                    ...
                    FingerPrintHandlerMyInfo fingerprintHandler = new FingerPrintHandlerMyInfo(getApplicationContext());
